 ...
 * <p>
 * This version of game.GameCanvas only supports both rectangular and polygonal Sprite
...
public class GameCanvas {
    ...
    public void dispose() {
        if (active != DrawPass.INACTIVE) {
            Gdx.app.error("game.GameCanvas", "Cannot dispose while drawing active", new IllegalStateException());
            return;
        }
        spriteBatch.dispose();
        spriteBatch = null;
    ...
    public void setWidth(int width) {
        if (active != DrawPass.INACTIVE) {
            Gdx.app.error("game.GameCanvas", "Cannot alter property while drawing active", new IllegalStateException());
            return;
        }
        this.width = width;
        if (!isFullscreen()) {
    ...
    public void drawPhysics(PolygonShape shape, Color color, float x, float y) {
        if (active != DrawPass.DEBUG) {
            Gdx.app.error("game.GameCanvas", "Cannot draw without active beginDebug()", new IllegalStateException());
            return;
        }
