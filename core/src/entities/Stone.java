...
public class Stone extends PolygonObstacle {
    ...
    public Stone(float[] points, float x, float y,float width, float height, float sc, float[] leftPos, float[] rightPos) {
        this(points, x, y, width, height, sc);
        setFriction(100f);
        isSliding = true;
        back = false;
    ...
    public Stone(float[] points, float x, float y,float width, float height, float sc, float[] rotatingCenter, float rotatingDegree) {
        this(points, x, y,width, height, sc);
        setFriction(100f);
