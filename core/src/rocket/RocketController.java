...
public class RocketController extends WorldController implements ContactListener {
    ...
    public void update(float dt) {
        ...
        float playerHorizontal = InputController.getInstance().getHorizontal();
        float playerVertical = InputController.getInstance().getVertical();
        Vector2 force = rocket.getForce();
        force.set(playerHorizontal * thrust, playerVertical * thrust);
        rocket.applyForce();
        //#endregion
